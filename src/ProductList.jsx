    ...
    const plantsArray = [
        ...
        },
        {
            ...
            plants: [
                ...
                { name: "Geraniums", image: "https://cdn.pixabay.com/photo/2012/04/26/21/51/flowerpot-43270_1280.jpg", description: "Known for insect-repelling properties and pleasant scent.", cost: "$20" },
                ...
                { name: "Lemongrass", image: "https://images.unsplash.com/photo-1654659932057-5163eb80289d?q=80&w=1935&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", description: "Natural mosquito repellent with a fresh citrus scent.", cost: "$11" }
            ]
        },
        {
            ...
            plants: [
                ...
                { name: "Lavender", image: "https://images.unsplash.com/photo-1611909023032-2d6b3134ecba?q=80&w=1074&auto=format&fit=crop", description: "Reduces anxiety and promotes restful sleep.", cost: "$20" },
                { name: "Aloe Vera", image: "https://cdn.pixabay.com/photo/2018/04/02/07/42/leaf-3283175_1280.jpg", description: "Soothes burns and skin irritations naturally.", cost: "$14" }
            ]
        },
        {
    ...
    return (
        <div>
            ...
            {!showCart ? (
                                ...
                                {category.plants.map((plant) => (
                                    <div className="product-card" key={plant.name}>
                                        ...
                                        <button
                                            ...
                                            style={{
                                                backgroundColor: addedToCart[plant.name] ? '#aaa' : '#4CAF50',
                                                color: 'white',
                ...
                <CartItem onContinueShopping={handleContinueShopping} onHomeClick={onHomeClick} />
            )}
        </div>
    );
}
